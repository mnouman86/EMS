...
internal class UpdateHotelCommandHandler : IRequestHandler<UpdateHotelCommand, OperationResult<bool>>
{
    ...
    public async ValueTask<OperationResult<bool>> Handle(UpdateHotelCommand request, CancellationToken cancellationToken)
    {
        using (var logger = _logger.LogMethodEntryExit(_httpContextAccessor?.HttpContext, request))
        {
            ...
            await _unitOfWork.HotelRepository.UpdateAsync(new Domain.Entities.Hotel.Hotel()
