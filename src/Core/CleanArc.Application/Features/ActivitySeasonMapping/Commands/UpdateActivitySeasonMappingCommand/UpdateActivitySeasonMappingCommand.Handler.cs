...
internal class UpdateActivitySeasonMappingCommandHandler:IRequestHandler<UpdateActivitySeasonMappingCommand, OperationResult<ResponseEntity>>
{
    ...
    public async ValueTask<OperationResult<ResponseEntity>> Handle(UpdateActivitySeasonMappingCommand request, CancellationToken cancellationToken)
    {
