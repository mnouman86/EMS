...
internal class GetRoomTypeByHotelIdQueryHandler : IRequestHandler<GetRoomTypeByHotelIdQuery, OperationResult<GetRoomTypeByHotelIdQueryResult>>
{
    ...
    public GetRoomTypeByHotelIdQueryHandler(IUnitOfWork unitOfWork, ILogger<GetRoomTypeByHotelIdQueryHandler> logger, IMapper mapper, IHttpContextAccessor httpContextAccessor)
    {
    ...
    public async ValueTask<OperationResult<GetRoomTypeByHotelIdQueryResult>> Handle(GetRoomTypeByHotelIdQuery request, CancellationToken cancellationToken)
    {
        ...
        {
            //var roomType = await _unitOfWork.RoomTypeRepository.GetByIdAsync(request.searchRequestById);

            //if (roomType == null)
            //{
            //    return OperationResult<GetRoomTypeByHotelIdQueryResult>.NotFoundResult("roomType not found");
            //}

            ////var result = new GetURLByIdQueryResult(url.Id, url.Path, url.Title, url.Description);
            //var result = _mapper.Map<GetRoomTypeByHotelIdQueryResult>(roomType);
