...
internal class UpdateMappingRoomAmenityCommandHandler : IRequestHandler<UpdateMappingRoomAmenityCommand, OperationResult<ResponseEntity>>
{
    ...
    private readonly ILogger<UpdateMappingRoomAmenityCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public UpdateMappingRoomAmenityCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<UpdateMappingRoomAmenityCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
