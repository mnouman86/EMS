...
internal class AddURLCommandHandler : IRequestHandler<AddURLCommand, OperationResult<bool>>
{
    ...
    public AddURLCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<AddURLCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
