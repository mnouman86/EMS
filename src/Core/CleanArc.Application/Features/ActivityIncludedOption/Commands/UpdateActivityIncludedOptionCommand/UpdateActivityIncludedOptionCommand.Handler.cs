...
internal class UpdateActivityIncludedOptionCommandHandler:IRequestHandler<UpdateActivityIncludedOptionCommand, OperationResult<bool>>
{
    ...
    private readonly ILogger<UpdateActivityIncludedOptionCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public UpdateActivityIncludedOptionCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<UpdateActivityIncludedOptionCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
