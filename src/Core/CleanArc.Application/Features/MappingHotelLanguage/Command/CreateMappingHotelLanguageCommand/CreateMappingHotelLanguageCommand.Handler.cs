...
internal class CreateMappingHotelLanguageCommandHandler : IRequestHandler<CreateMappingHotelLanguageCommand, OperationResult<ResponseEntity>>
{
    ...
    private readonly ILogger<CreateMappingHotelLanguageCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
                                                                //private readonly IUnitOfWork _unitOfWork;
                                                                //private readonly IAppUserManager _userManager;


    public CreateMappingHotelLanguageCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreateMappingHotelLanguageCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
