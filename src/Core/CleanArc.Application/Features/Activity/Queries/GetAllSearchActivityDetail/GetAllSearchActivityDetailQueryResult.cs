...
public class GetAllSearchActivityDetailQueryResult
{
    public List<GetAllSearchActivityDetail> ActivityDetail { get; set; }
    public Decimal? ActivityPriceMinimum { get; set; }
    public Decimal? ActivityPriceMaximum { get; set; }
}
public class GetAllSearchActivityDetail
{
