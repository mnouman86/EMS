...
internal class DeleteActivityAddressCommandHandler: IRequestHandler<DeleteActivityAddressCommand, OperationResult<bool>>
{
    ...
    public async ValueTask<OperationResult<bool>> Handle(DeleteActivityAddressCommand request, CancellationToken cancellationToken)
    {
