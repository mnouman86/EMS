...
internal class UpdateActivityAddressCommandHandler:IRequestHandler<UpdateActivityAddressCommand, OperationResult<ResponseEntity>>
{
    ...
    public async ValueTask<OperationResult<ResponseEntity>> Handle(UpdateActivityAddressCommand request, CancellationToken cancellationToken)
    {
