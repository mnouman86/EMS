...
{
    public record UpdateRoomVisualCommand(int ID, int? HotelID, int? RoomID, int? CategoryID, String? ImagePath, string? ImageTitle, bool? IsMain, int? UpdatedBy) : IRequest<OperationResult<bool>>,
