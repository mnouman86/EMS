...
internal class CreateDisabilityOptionCommandHandler: IRequestHandler<CreateDisabilityOptionCommand, OperationResult<bool>>
{
    ...
    private readonly ILogger<CreateDisabilityOptionCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public CreateDisabilityOptionCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreateDisabilityOptionCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
