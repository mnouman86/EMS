...
internal class UpdateDisabilityOptionCommandHandler:IRequestHandler<UpdateDisabilityOptionCommand, OperationResult<bool>>
{
    ...
    public async ValueTask<OperationResult<bool>> Handle(UpdateDisabilityOptionCommand request, CancellationToken cancellationToken)
    {
        using (var logger = _logger.LogMethodEntryExit(_httpContextAccessor?.HttpContext, request))
        {
            ...
            await _unitOfWork.DisabilityOptionRepository.UpdateAsync(new Domain.Entities.DisabilityOption.DisabilityOption()
