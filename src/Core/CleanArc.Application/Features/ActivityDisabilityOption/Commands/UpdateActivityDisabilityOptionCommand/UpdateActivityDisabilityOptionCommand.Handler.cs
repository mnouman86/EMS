...
internal class UpdateActivityDisabilityOptionCommandHandler:IRequestHandler<UpdateActivityDisabilityOptionCommand, OperationResult<ResponseEntity>>
{
    ...
    private readonly ILogger<UpdateActivityDisabilityOptionCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public UpdateActivityDisabilityOptionCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<UpdateActivityDisabilityOptionCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
