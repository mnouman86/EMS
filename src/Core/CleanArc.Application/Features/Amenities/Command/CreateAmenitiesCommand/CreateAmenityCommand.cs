...
public record CreateAmenityCommand(string? Name, string? Description, int? CategoryID,int? ServiceCategoryID, string? Icon, int? CreatedBy) : IRequest<OperationResult<bool>>,
