...
public record CreateAmenityCommand(string? Name, string? Description, int? ServiceTypeEnumId, string? Icon, int? CultureId) : IRequest<OperationResult<ResponseEntity>>,
