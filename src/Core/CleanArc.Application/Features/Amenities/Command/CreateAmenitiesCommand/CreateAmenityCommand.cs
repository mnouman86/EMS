...
public record CreateAmenityCommand(string? Name, string? Description, int? AmenityTypeEnumID, string? Icon, int? CultureId) : IRequest<OperationResult<ResponseEntity>>,
