...
public record UpdateAmenityCommand(int ID, String? Name, string? Description,int? CategoryID, int? ServiceCategoryID, string? Icon, int? UpdatedBy) : IRequest<OperationResult<bool>>,
