...
internal class CreateCategoryCommandHandler : IRequestHandler<CreateCategoryCommand, OperationResult<bool>>
{
    ...
    public CreateCategoryCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreateCategoryCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
