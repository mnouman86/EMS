...
public record CreateAmenityMappingCommand(int? GenericTitleId, int[]? AmenitiesIDs, int? CultureId, int? ServiceTypeEnumId) : IRequest<OperationResult<ResponseEntity>>,
