...
internal class CreateActivityTypeCommandHandler: IRequestHandler<CreateActivityTypeCommand, OperationResult<ResponseEntity>>
{
    ...
    public async ValueTask<OperationResult<ResponseEntity>> Handle(CreateActivityTypeCommand request, CancellationToken cancellationToken)
    {
