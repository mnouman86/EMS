...
public record UpdateCoreAreaCommand( int ID,String? Name, string? Description, int? Type, string? ImagePath, int? UpdatedBy, int? CultureId) : IRequest<OperationResult<ResponseEntity>>,
