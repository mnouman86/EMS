...
internal class CreateCountryCommandHandler : IRequestHandler<CreateCountryCommand, OperationResult<bool>>
{
    ...
    public async ValueTask<OperationResult<bool>> Handle(CreateCountryCommand request, CancellationToken cancellationToken)
    {
        using (var logger = _logger.LogMethodEntryExit(_httpContextAccessor?.HttpContext, request))
        {
            ...
            await _unitOfWork.CountryRepository.AddAsync(new Domain.Entities.Country.Country()
