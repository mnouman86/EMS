...
internal class CreatePackageDetailCommandHandler: IRequestHandler<CreatePackageDetailCommand, OperationResult<bool>>
{
    ...
    private readonly ILogger<CreatePackageDetailCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public CreatePackageDetailCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreatePackageDetailCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
