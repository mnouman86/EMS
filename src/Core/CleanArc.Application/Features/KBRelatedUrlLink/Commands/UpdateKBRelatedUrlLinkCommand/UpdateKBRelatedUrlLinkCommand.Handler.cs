...
internal class UpdateKBRelatedUrlLinkCommandHandler:IRequestHandler<UpdateKBRelatedUrlLinkCommand, OperationResult<bool>>
{
    ...
    private readonly ILogger<UpdateKBRelatedUrlLinkCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public UpdateKBRelatedUrlLinkCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<UpdateKBRelatedUrlLinkCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
