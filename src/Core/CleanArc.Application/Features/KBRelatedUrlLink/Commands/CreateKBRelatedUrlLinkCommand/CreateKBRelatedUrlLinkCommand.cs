...
public record CreateKBRelatedUrlLinkCommand(int? KBDetailID,string? Title, string? Description, string? URL, int? CreatedBy, int? CultureId) : IRequest<OperationResult<ResponseEntity>>,
