...
internal class CreateCityCommandHandler : IRequestHandler<CreateCityCommand, OperationResult<ResponseEntity>>
{
    ...
    public CreateCityCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreateCityCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
