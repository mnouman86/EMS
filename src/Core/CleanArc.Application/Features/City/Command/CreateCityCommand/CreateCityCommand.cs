...
public record CreateCityCommand(string? Name, string? Description, int? StateLookUpId,bool? IsMain,  string? ImagePath , string? ImageTitle, int? CultureId) : IRequest<OperationResult<ResponseEntity>>,
