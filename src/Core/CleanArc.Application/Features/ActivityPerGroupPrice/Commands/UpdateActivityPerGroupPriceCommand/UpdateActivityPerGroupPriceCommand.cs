...
public record UpdateActivityPerGroupPriceCommand(int ID, int? ActivityID, int? MinGroupSize, int? MaxGroupSize, decimal? Price, int? UpdatedBy) : IRequest<OperationResult<bool>>,
