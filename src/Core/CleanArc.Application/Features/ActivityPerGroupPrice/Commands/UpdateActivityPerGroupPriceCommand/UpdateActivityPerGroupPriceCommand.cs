...
public record UpdateActivityPerGroupPriceCommand(int ID, int? ActivityID, int? MinGroupSize, int? MaxGroupSize, decimal? Price, int? UpdatedBy, int? CultureId) : IRequest<OperationResult<bool>>,
