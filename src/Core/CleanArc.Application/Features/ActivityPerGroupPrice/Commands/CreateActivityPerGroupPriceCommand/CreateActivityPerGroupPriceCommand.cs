...
public record CreateActivityPerGroupPriceCommand(int? ActivityID, int? MinGroupSize, int? MaxGroupSize, decimal? Price, int? CreatedBy) : IRequest<OperationResult<bool>>,
