...
internal class UpdateRoomDetailCommandHandler : IRequestHandler<UpdateRoomDetailCommand, OperationResult<bool>>
{
    ...
    public async ValueTask<OperationResult<bool>> Handle(UpdateRoomDetailCommand request, CancellationToken cancellationToken)
    {
        using (var logger = _logger.LogMethodEntryExit(_httpContextAccessor?.HttpContext, request))
        {
            ...
            await _unitOfWork.RoomDetailsRepository.UpdateAsync(new Domain.Entities.RoomDetails.RoomDetails()
            {
                UpdatedBy = user.Id,
                ID = request.ID,
