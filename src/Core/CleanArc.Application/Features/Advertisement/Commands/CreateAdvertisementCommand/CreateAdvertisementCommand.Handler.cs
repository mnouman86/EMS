...
internal class CreateAdvertisementCommandHandler: IRequestHandler<CreateAdvertisementCommand, OperationResult<bool>>
{
    ...
    public CreateAdvertisementCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreateAdvertisementCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
