...
internal class CreateCurrencyCommandHandler: IRequestHandler<CreateCurrencyCommand, OperationResult<ResponseEntity>>
{
    ...
    public CreateCurrencyCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreateCurrencyCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
