...
public record CreateCampaignScheduleCommand(string? Title, 
string? Description,
string? StartDate,
//string EndDate,
int? Duration,
...
int? CreatedBy) : IRequest<OperationResult<ResponseEntity>>,
    IValidatableModel<CreateCampaignScheduleCommand>
{
    [JsonIgnore]
    public int UserId { get; set; }
    public IValidator<CreateCampaignScheduleCommand> ValidateApplicationModel(ApplicationBaseValidationModelProvider<CreateCampaignScheduleCommand> validator)
    {
