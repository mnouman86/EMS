...
{
    internal class CreateHotelImageCommandHandler : IRequestHandler<CreateHotelImageCommand, OperationResult<bool>>
    {
        ...
        public async ValueTask<OperationResult<bool>> Handle(CreateHotelImageCommand request, CancellationToken cancellationToken)
        {
            using (var logger = _logger.LogMethodEntryExit(_httpContextAccessor?.HttpContext, request))
            {
                ...
                await _unitOfWork.HotelImageRepository.AddAsync(new Domain.Entities.HotelImage.Hotel_Image()
                { CreatedBy = user.Id,
