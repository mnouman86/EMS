...
public record CreateActivityImageMappingCommand(int? ActivityID, List<string>? ImagePaths, string? ImageTitle, bool? IsMain, int? CreatedBy,int? CultureId) : IRequest<OperationResult<ResponseEntity>>,
