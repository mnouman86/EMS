...
internal class UpdateCarImageCommandHandler : IRequestHandler<UpdateCarImageCommand, OperationResult<ResponseEntity>>
{
    ...
    private readonly ILogger<UpdateCarImageCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
                                                                //private readonly IUnitOfWork _unitOfWork;
                                                                //private readonly IAppUserManager _userManager;


    public UpdateCarImageCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<UpdateCarImageCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
