...
public record CreateSearchFilterThingsToDoCommand(
   int? CultureId,
    string? Title,
    ...
    IValidatableModel<CreateSearchFilterThingsToDoCommand>
{
    ...
    public IValidator<CreateSearchFilterThingsToDoCommand> ValidateApplicationModel(ApplicationBaseValidationModelProvider<CreateSearchFilterThingsToDoCommand> validator)
    {
