...
{
    internal class GetSearchFilterThingsToDoByIdQueryHandler : IRequestHandler<GetSearchFilterThingsToDoByIdQuery, OperationResult<GetSearchFilterThingsToDoByIdQueryResult>>
    {
