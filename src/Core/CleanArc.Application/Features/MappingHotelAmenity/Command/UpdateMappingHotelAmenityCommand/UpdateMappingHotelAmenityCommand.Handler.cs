...
internal class UpdateMappingHotelAmenityCommandHandler : IRequestHandler<UpdateMappingHotelAmenityCommand, OperationResult<bool>>
{
    ...
    public async ValueTask<OperationResult<bool>> Handle(UpdateMappingHotelAmenityCommand request, CancellationToken cancellationToken)
    {
