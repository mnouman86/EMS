...
internal class UpdateActivityIDImageMappingCommandHandler:IRequestHandler<UpdateActivityIDImageMappingCommand, OperationResult<bool>>
{
    ...
    private readonly ILogger<UpdateActivityIDImageMappingCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public UpdateActivityIDImageMappingCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<UpdateActivityIDImageMappingCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
