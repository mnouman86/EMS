...
{
    public record CreatePolicyCommand(int? RatePlanTypeID, int? RefundPolicyTypeLookUpID, decimal? DeductionPercentage, int? CultureId) : IRequest<OperationResult<ResponseEntity>>,
