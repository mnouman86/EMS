...
internal class CreateActivityManagerCommandHandler: IRequestHandler<CreateActivityManagerCommand, OperationResult<bool>>
{
    ...
    public async ValueTask<OperationResult<bool>> Handle(CreateActivityManagerCommand request, CancellationToken cancellationToken)
    {
        using (var logger = _logger.LogMethodEntryExit(_httpContextAccessor?.HttpContext, request))
        {
            ...
            await _unitOfWork.ActivityManagerRepository.AddAsync(new Domain.Entities.ActivityManager.ActivityManager()
