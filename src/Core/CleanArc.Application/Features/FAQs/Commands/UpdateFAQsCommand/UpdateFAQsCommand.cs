...
public record UpdateFAQsCommand(int ID,int? CategoryServiceID, int? ServiceID, int? SubServiceID, string? Question, string? Answer, int? UpdatedBy, int? CultureId) : IRequest<OperationResult<bool>>,
