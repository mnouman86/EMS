...
internal class CreateFAQsCommandHandler: IRequestHandler<CreateFAQsCommand, OperationResult<ResponseEntity>>
{
    ...
    public async ValueTask<OperationResult<ResponseEntity>> Handle(CreateFAQsCommand request, CancellationToken cancellationToken)
    {
