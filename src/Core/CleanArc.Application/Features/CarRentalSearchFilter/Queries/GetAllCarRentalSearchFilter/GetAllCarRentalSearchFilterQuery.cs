...
public record GetAllCarRentalSearchFilterQuery(CarRentalSearchFilterRequest searchRequest) : IRequest<OperationResult<List<GetAllCarRentalSearchFilterQueryResult>>>;
