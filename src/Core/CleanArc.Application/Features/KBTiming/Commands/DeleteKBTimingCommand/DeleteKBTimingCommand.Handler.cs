...
internal class DeleteKBTimingCommandHandler: IRequestHandler<DeleteKBTimingCommand, OperationResult<bool>>
{
    ...
    private readonly ILogger<DeleteKBTimingCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
    //private readonly IUnitOfWork _unitOfWork;
    //private readonly IAppUserManager _userManager;


    public DeleteKBTimingCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<DeleteKBTimingCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
