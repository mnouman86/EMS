...
internal class CreateRoomSizeUnitCommandHandler : IRequestHandler<CreateRoomSizeUnitCommand, OperationResult<bool>>
{
    ...
    private readonly ILogger<CreateRoomSizeUnitCommandHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor
                                                                //private readonly IUnitOfWork _unitOfWork;
                                                                //private readonly IAppUserManager _userManager;


    public CreateRoomSizeUnitCommandHandler(IUnitOfWork unitOfWork, IAppUserManager userManager, IConfiguration configuration, IMapper mapper, ILogger<CreateRoomSizeUnitCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
    {
