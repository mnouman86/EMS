...
internal class GetAllRoomImagesQueryHandler : IRequestHandler<GetAllRoomImagesQuery, OperationResult<List<GetAllRoomImagesQueryResult>>>
{

    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;
    private readonly ILogger<GetAllRoomImagesQueryHandler> _logger;
    private readonly IHttpContextAccessor _httpContextAccessor; // Add IHttpContextAccessor


    public GetAllRoomImagesQueryHandler(IUnitOfWork unitOfWork, IMapper mapper, IHttpContextAccessor httpContextAccessor, ILogger<GetAllRoomImagesQueryHandler> logger)
    {
    ...
    public async ValueTask<OperationResult<List<GetAllRoomImagesQueryResult>>> Handle(GetAllRoomImagesQuery request, CancellationToken cancellationToken)
    {
