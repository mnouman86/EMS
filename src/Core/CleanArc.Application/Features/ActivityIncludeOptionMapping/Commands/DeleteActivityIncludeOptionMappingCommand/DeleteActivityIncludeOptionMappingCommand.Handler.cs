...
internal class DeleteActivityIncludeOptionMappingCommandHandler: IRequestHandler<DeleteActivityIncludeOptionMappingCommand, OperationResult<ResponseEntity>>
{
    ...
    public async ValueTask<OperationResult<ResponseEntity>> Handle(DeleteActivityIncludeOptionMappingCommand request, CancellationToken cancellationToken)
    {
