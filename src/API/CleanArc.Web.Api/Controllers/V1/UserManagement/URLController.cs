...
/// </summary>
/// <seealso cref="CleanArc.WebFramework.BaseController._BaseController{AddURLCommand, UpdateURLCommand, DeleteURLCommand, Boolean, GetAllURLsQuery,GetAllURLsQueryResult, GetURLByIdQuery, GetURLByIdQueryResult}" />
/// <remarks>
    ...
    List<GetAllURLsQueryResult>, GetURLByIdQuery, GetURLByIdQueryResult>
{
    ...
    public UrlController(ISender sender, ILogger<_BaseController<AddURLCommand, UpdateURLCommand, DeleteURLCommand, bool, GetAllURLsQuery,
