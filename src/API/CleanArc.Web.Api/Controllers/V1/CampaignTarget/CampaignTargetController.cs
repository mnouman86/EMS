...
{
    /// <summary>
    /// CampaignTargetController is responsible for handling HTTP requests related to room type operations
    ...
    /// 
    /// 1. CreateCampaignTarget: Handles the creation of a new room type.
    /// 2. UpdateCampaignTarget: Handles the updating of an existing room type.
    /// 3. DeleteCampaignTarget: Handles the deletion of an existing room type.
    /// 4. GetAllCampaignTargets: Retrieves all room types.
    ...
    /// version, specified as "api/v{version:apiVersion}/CampaignTarget".
    /// 
